export default function CurrentBalance() {
    return (
        <div className="w-[400px] h-[190px] 2xl:w-[761px] 2xl:h-[250px] bg-[#369DC9] flex justify-between rounded-xl">
            <div className="ml-10 mt-8 flex flex-col gap-5">
                <div className="text-xl text-white font-semibold">Current Balance</div>
                <div className="text-4xl 2xl:text-[64px] text-white font-bold">$ 82,683.82</div>
                <div className="2xl:mt-10 text-base text-white font-normal">1234 **** 9876</div>
            </div>
